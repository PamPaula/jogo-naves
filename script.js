...
function start() {
    ...
    function explosao1(inimigo1X, inimigo1Y) {
        ...
        div.animate({width: 200, opcity: 0}, "slow");
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over! </h1><p>Sua pontuação foi: " + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Jogar Novamente</h3></div>");
    }
} //fim do jogo